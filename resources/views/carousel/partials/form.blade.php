...
<div class="form-group">
	<input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre Imagen" value="{{ $carousel->nombre or old('nombre') }}">
</div>
<div class="form-group">
	<input type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Descripcion Imagen" value="{{ $carousel->descripcion or old('descripcion') }}">
</div>
